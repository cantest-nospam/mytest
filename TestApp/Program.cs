...
public class Program
{
    ...
    public static async Task ExecuteAsync()
    {
        ...
        string authJson = @"{
                ...
                ""redirect_uris"": [ ""https://github.com/cantest-nospam/mytest/blob/errata/README.md"" ]
              }
            }";
        ...
        Google.Apis.Auth.OAuth2.Web.AuthorizationCodeWebApp webapp = new Google.Apis.Auth.OAuth2.Web.AuthorizationCodeWebApp(flow, "https://github.com/cantest-nospam/mytest/blob/errata/README.md", "");
