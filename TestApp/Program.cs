...
public class Program
{
    ...
    public static async Task ExecuteAsync()
    {
        ...
        Google.Apis.Auth.OAuth2.Web.AuthorizationCodeWebApp webapp = new Google.Apis.Auth.OAuth2.Web.AuthorizationCodeWebApp(flow, "storagerelay://https/github.com/cantest-nospam/mytest/blob/errata/README.md", "");
